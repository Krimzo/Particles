...
std::optional<std::string> choose_file( bool save, std::initializer_list<std::pair<std::string_view, std::string_view>> const& filters = { { "All Files", ".*" } }, int* out_index = nullptr );
std::optional<std::wstring> wchoose_file( bool save, std::initializer_list<std::pair<std::wstring_view, std::wstring_view>> const& filters = { { L"All Files", L".*" } }, int* out_index = nullptr );
